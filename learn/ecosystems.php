...
<img src="../img/learn/ecosystem-2.jpg" width="1400" alt="Aquatic ecosystem - An aquascape">
</div>
...
<div class="fullwidth-image">
<img src="../img/learn/ecosystem-balance.jpg" alt="An aquascape">
</div>
</div><!-- .section-container -->
...
<div class="section-container">
<div class="section-content">
<div class="section-heading center section-2">
<a class="anchor" id="aquaponic"></a>The aquaponic cycle
</div><!-- .section-heading -->
<div id="acuaponic-cycle-infographic">
<img src="../img/learn/aquaponiccycle.png" alt="The aquaponic cycle">
</div>
</div><!-- .section-content -->
</div><!-- .section-container -->
...
<div class="component-heading" id="fish-heading">
FISH
</div>
...
<div class="component-top-section">
<div class="component-icon">
<img src="../img/learn/aquatic-plant-icon.png" alt="Aquatic plant icon">
</div>
<div class="component-heading" id="aquatic-plants-heading">
AQUATIC PLANTS
</div>
...
<div class="component-top-section">
<div class="component-icon">
<img src="../img/learn/terrestrial-plant-icon.png" alt="terrestrial plant icon">
</div>
<div class="component-heading" id="terrestrial-plants-heading">
TERRESTRIAL <br> PLANTS
</div>
...
updateDotsChildDir("section-3");
} else if ($(".section-4").visible()) {
updateDotsChildDir("section-4");
} else if ($(".section-5").visible()) {
updateDotsChildDir("section-5");
}
});
</script>
